...
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-discrete-uniform/tags). For example,

```javascript
import discreteUniform from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-discrete-uniform@v0.0.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-discrete-uniform@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-array-discrete-uniform/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/random-array-discrete-uniform/actions/workflows/test.yml?query=branch:v0.0.1
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-discrete-uniform.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-discrete-uniform/main
...
[@stdlib/random/base/discete-uniform]: https://github.com/stdlib-js/random-base-discete-uniform/tree/deno
