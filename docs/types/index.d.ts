...
/**
* Interface for generating pseudorandom numbers drawn from a discrete uniform distribution with pre-specified parameter values.
*/
interface UnaryFunction extends PRNG {
	...
	*/
	...
	/**
	* Fills an array with pseudorandom numbers drawn from a discrete uniform distribution.
	*
...
/**
* Interface for generating pseudorandom numbers drawn from a discrete uniform distribution without pre-specified parameter values.
*/
